...
<div class="animate-fade-in-up max-w-6xl mx-auto">
    ...
    <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 border border-purple-100 mb-10 shadow-xl animate-slide-in" style="animation-delay: 0.1s">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                @foreach ($categories as $category)
                    <div class="relative">
                        ...
                        <label class="flex items-center p-4 bg-white border-2 border-gray-200 rounded-xl cursor-pointer hover:shadow-md transition-all duration-300 peer-checked:border-purple-500 peer-checked:bg-gradient-to-r peer-checked:from-purple-50 peer-checked:to-pink-50 peer-checked:shadow-lg group" 
                               for="cat{{ $category->id }}">
                            <div class="flex items-center space-x-3">
                                <div class="w-6 h-6 border-2 border-gray-300 rounded-lg flex items-center justify-center peer-checked:border-purple-500 peer-checked:bg-purple-500 group-hover:border-purple-400 transition-all duration-300">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="font-semibold text-gray-700 group-hover:text-purple-600 peer-checked:text-purple-700">{{ $category->name }}</span>
                                </div>
                            </div>
                        </label>
                    </div>
    ...
    <!-- Question Card -->
    <div class="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden animate-fade-in-up" style="animation-delay: 0.2s">
        <div class="p-8 md:p-12">
            @if (isset($message))
                <!-- Empty State -->
                <div class="text-center py-16">
                    <div class="w-24 h-24 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center mx-auto mb-8 shadow-inner">
                        <i class="fas fa-book-open text-blue-500 text-3xl"></i>
                    </div>
                    <h4 class="text-3xl font-bold text-gray-800 mb-4">{{ $message }}</h4>
                    <p class="text-xl text-gray-600 mb-8">Comece criando sua primeira questão para começar a estudar!</p>
            ...
            @else
                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 bg-gradient-to-r from-orange-500 to-yellow-600 rounded-xl flex items-center justify-center">
                            <i class="fas fa-folder text-white"></i>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Categoria</p>
                            <p class="text-lg font-bold text-gray-800">{{ $question->category->name ?? 'Não definida' }}</p>
                        </div>
                    </div>
                    <span class="px-4 py-2 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 rounded-full text-sm font-bold border border-blue-200">
                ...
                <div id="question-container">
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-8 mb-8 border border-indigo-100">
                        <h4 class="text-2xl font-bold text-gray-800 leading-relaxed" id="question-text">{{ $question->question_text }}</h4>
                    </div>
                        ...
                        @foreach ($question->options as $key => $option)
                            <button class="option-btn group w-full p-6 bg-white hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 rounded-2xl border-2 border-gray-200 hover:border-transparent text-left transition-all duration-300 hover:text-white hover:shadow-xl hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-indigo-100" 
                                ...
                                <div class="flex items-center">
                                    <span class="w-8 h-8 bg-gradient-to-r from-gray-100 to-gray-200 group-hover:from-white/20 group-hover:to-white/20 rounded-full flex items-center justify-center text-sm font-bold mr-6 transition-all duration-300 shadow-sm">
                                        {{ strtoupper($key) }}
                                    </span>
                    ...
                    <div id="reason-container" 
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p id="reason-text" class="text-blue-700 leading-relaxed text-lg">{{ $question->reason }}</p>
                            </div>
                        </div>
                    </div>
