...
<div class="animate-fade-in-up">
    ...
    <div class="text-center mb-10">
        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-3xl mb-6 shadow-xl">
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden animate-slide-in" style="animation-delay: 0.2s">
                ...
                <form id="question-form" action="{{ route('questions.store') }}" method="POST" class="space-y-8">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            <textarea id="question_text" 
                                      ...
                                      name="question_text"
                                      rows="6" 
                                      placeholder="Digite o enunciado da questão...">{{ old('question_text') }}</textarea>
                        ...
                        @enderror
                        <div class="mt-3 p-4 bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-yellow-700 text-sm mt-1">Você pode colar a questão inteira com as opções A), B), C), D) que o sistema separa automaticamente!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-2">
                                        <span class="w-6 h-6 bg-purple-500 text-white rounded-full flex items-center justify-center text-xs font-bold">A</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-2">
                                        <span class="w-6 h-6 bg-purple-500 text-white rounded-full flex items-center justify-center text-xs font-bold">C</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-2">
                                        <span class="w-6 h-6 bg-purple-500 text-white rounded-full flex items-center justify-center text-xs font-bold">D</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                <select class="w-full px-6 py-4 bg-white border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 transition-all duration-300 text-gray-800 font-medium appearance-none cursor-pointer hover:shadow-md @error('correct_answer') border-red-400 @enderror"
                                        name="correct_answer">
                                    <option value="">Selecione a resposta correta</option>
                                    <option value="a" {{ old('correct_answer') === 'a' ? 'selected' : '' }}>Opção A</option>
                                    <option value="b" {{ old('correct_answer') === 'b' ? 'selected' : '' }}>Opção B</option>
                                    <option value="c" {{ old('correct_answer') === 'c' ? 'selected' : '' }}>Opção C</option>
                                    <option value="d" {{ old('correct_answer') === 'd' ? 'selected' : '' }}>Opção D</option>
                                </select>
                                <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            <textarea class="w-full px-6 py-4 bg-gradient-to-br from-cyan-50 to-blue-50 border-2 border-cyan-200 rounded-2xl focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition-all duration-300 text-gray-800 placeholder-gray-400 font-medium text-lg resize-none @error('reason') border-red-400 @enderror" 
                                      name="reason" 
                                      rows="4"
